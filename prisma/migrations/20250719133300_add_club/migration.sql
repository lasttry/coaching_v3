...
*/
-- CreateEnum
CREATE TYPE "ClubRole" AS ENUM ('OWNER', 'MANAGER', 'COACH', 'MEMBER');
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_defaultClubId_fkey" FOREIGN KEY ("defaultClubId") REFERENCES "Club"("id") ON DELETE SET NULL ON UPDATE CASCADE;
